...
const BLUR_HASHES = {
  ...
  fantasy: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAECAYAAACzzX7wAAAAAXNSR0IArs4c6QAAACVJREFUGFdjdPbvP5//+/fv/z9s2LAtYGJgYPhPfv784d27d5sYGBgAAPk0Dk9B1FpGAAAAAElFTkSuQmCC',
...
export const retroArticles: RetroArticle[] = [
    { id: 5, slug: 'chronicles-of-time-retrospective', game: 'Chronicles of Time', title: "Chronicles of Time: A Retrospective", year: 1995, imageUrl: "https://picsum.photos/seed/chrono/400/300", tags: ["RPG", "Classic", "JRPG"], blurDataURL: BLUR_HASHES.fantasy },
    { id: 6, slug: 'super-metroid-echoes', game: 'Super Metroid', title: "Super Metroid: The Masterpiece That Still Echoes", year: 1994, imageUrl: "https://picsum.photos/seed/metroid/400/300", tags: ["Action", "Platformer", "Sci-Fi"], blurDataURL: BLUR_HASHES.scifi },
];

export const newsItems: NewsItem[] = [
    { id: 10, slug: 'ghibli-rpg-partnership', game: null, title: "Studio Ghibli partners with indie studio for new RPG.", category: "Industry", imageUrl: "https://images.unsplash.com/photo-1542856334-c361993335a9?q=80&w=1964&auto=format&fit=crop", date: "October 27, 2077", tags: ["RPG", "Industry"], blurDataURL: BLUR_HASHES.nature },
    { id: 11, slug: 'portal-vr-headset', game: null, title: "Next-gen VR headset 'Portal' to feature sensory feedback.", category: "Hardware", imageUrl: "https://images.unsplash.com/photo-1593508512255-86ab42a8e620?q=80&w=1778&auto=format&fit=crop", date: "October 27, 2077", tags: ["Hardware", "VR"], blurDataURL: BLUR_HASHES.tech },
    { id: 14, slug: 'starfall-online-patch-7-2', game: 'Starfall Online', title: "Patch 7.2 for 'Starfall Online' brings massive overhaul.", category: "Updates", imageUrl: "https://images.unsplash.com/photo-1570314271131-9a7445a5d290?q=80&w=2070&auto=format&fit=crop", date: "October 26, 2077", tags: ["MMO", "Sci-Fi", "Updates"], blurDataURL: BLUR_HASHES.scifi },
];
